...
public class ConsultaProveedor extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbProveedor.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccionar:", "Nombre", "Apellido", "Empresa", "Email" }));
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addComponent(cbProveedor, 0, 172, Short.MAX_VALUE)
    ...
    private void SiguienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SiguienteMouseClicked
        ConsultaFactura mf = new ConsultaFactura();
        mf.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_SiguienteMouseClicked

    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        FactPromax.consultaProveedor(txtBuscar.getText(), cbProveedor.getSelectedItem().toString(), tblProveedor);
